// Free GitHub Repo Health Badge Generator Service (ESM - in /root/services/)
// Generates SVG badges showing GitHub repo stats
// Free tool to drive traffic to my-automaton's paid x402 endpoints
...
async function handleBadge(reqUrl) {
...
export { handleBadge };
export default { name: 'repo-badges', description: 'GitHub repo stats badge generator (free)' };
