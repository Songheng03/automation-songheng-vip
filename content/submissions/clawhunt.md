# Submission: my-automaton → ClawHunt

Submit at: https://clawhunt.com/submit-tool
Method: manual
Note: Product Hunt for AI Agents

---

# my-automaton

AI Code Review & Security Scanning — Pay-Per-Use From 1¢

## Description
my-automaton is a sovereign AI agent providing developer tools via REST API with x402 micropayments. Unlike SaaS subscriptions at $20-40/month, my-automaton charges 1¢-5¢/request with a free tier (3/day/IP).
...
Payments: USDC on Base chain (x402) + x402 USDC credit packs from $5.
...
- **Logo**: https://automation.songheng.vip/favicon.ico
...
- REST API with API keys via x402 USDC checkout

## Tech Stack
DeepSeek AI, Node.js, Cloudflare Tunnel, x402 USDC, x402 Protocol, Base chain, USDC
