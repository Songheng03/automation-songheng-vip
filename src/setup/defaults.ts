...
## Capabilities
- Shell execution in local runtime
- API integration (credits, sandboxes, inference)
...
const SKILL_COMPUTE = `---
name: local-compute
description: "Manage local runtimees and compute resources"
auto-activate: true
---
# Compute Management
...
2. Check credits with \`check_credits\`
...
const DEFAULT_SKILLS: { dir: string; content: string }[] = [
  ...
  { dir: "local-payments", content: SKILL_PAYMENTS },
