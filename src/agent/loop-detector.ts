      ...
      if (allSame) {
        if (this.patternWarningIssued === pattern) {
          ...
          return {
            ...
            reason:
              ...
              `but continued. You MUST write code NOW. Stop reading files. ` +
              `Pick a file and write to it with write_file, or call task_done with a summary. ` +
              `Do NOT call: ${pattern}.`,
          };
        }
        ...
        return {
          ...
          reason:
            ...
            `This looks like a loop. On your next turn, you MUST write code instead of reading. ` +
