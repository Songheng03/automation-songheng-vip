...
export interface AutomatonConfig {
   ...
   *  Defaults to https://api.openai.com when not set. */
...
export interface LocalRuntime {
  ...
  createScopedClient(targetSandboxId: string): LocalRuntime;
}
...
export type ModelProvider = "openai" | "anthropic" | "ollama" | "other";
