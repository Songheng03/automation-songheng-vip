#!/bin/sh
# my-automaton Local Installer (modified from Conway Research)
# This is a LOCAL installation script for the modified automaton.
# REPO is local-only; no upstream GitHub repo exists.
set -e

INSTALL_DIR="/root/automaton"
