...
// The promotion engine code to inject before END TRAFFIC ENGINE
const promoEngine = `
// === PROMOTION ENGINE ===
...
function logPromoRun(messages, platforms) {
  ...
  trafficLog('PROMO', 'cycle', messages.length + ' msgs x ' + platforms.length + ' platforms = ' + count + ' links');
}
...
console.log('Gateway patched successfully with promotion engine');
